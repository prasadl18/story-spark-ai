              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="flex items-center justify-between text-sm text-slate-500 border-t border-slate-700/50 pt-4 mt-auto">
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className={`flex items-center gap-1.5 transition-colors group/btn ${
                        story.reactions?.some(
                          (r) => r.userId?.email === currentUser?.email
                        )
                          ? "text-red-400"
                          : "hover:text-red-400"
                      }`}
                      ...
                      <i
                        className={`${
                          story.reactions?.some(
                            ...
                            ? "fas"
                            : "far"
                        } fa-heart group-hover/btn:scale-110 transition-transform`}
                        aria-hidden="true"
                      ></i>{" "}
                    ...
                    >
                      <i
                        className="far fa-comment group-hover/btn:scale-110 transition-transform"
                        aria-hidden="true"
                      ></i>{" "}
